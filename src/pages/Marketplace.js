...
function Marketplace(props) {
  ...
  return (
    <div className="marketplace">
      ...
      <div className="gallery gallery--marketplace">
        {/*<iframe title="" width="100%" height="300"
          src="https://huntees.com/"
          referrerPolicy="noreferrer"></iframe>*/}

        {Object.keys(vendors).map(v => (
          <div className="gallery__item" key={v}>
            <div className="gallery__item_image">
              <a href={vendors[v]["link"]} target="_blank" rel="noreferrer"><img src={"/img/vendors/" + vendors[v]["logo"]} alt={v + " cover"} /></a>
            </div>
            <p><a href={vendors[v]["link"]} target="_blank" rel="noreferrer">{v}</a></p>
            <p>{vendors[v]["description"]}</p>
          </div>
        ))}
      </div>
